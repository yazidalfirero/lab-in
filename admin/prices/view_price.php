...
<div class="container-fluid">
    <div class="row">
            <dl>
                ...
                <dt class="text-muted">Pemeriksaan</dt>
                ...
                <dt class="text-muted">Nilai Normal</dt>
                <dd class='pl-4 fs-4 fw-bold'><?= isset($normalvalue) ? $normalvalue : 'N/A' ?></dd>
                
                <dt class="text-muted">Satuan</dt>
                <dd class='pl-4 fs-4 fw-bold'><?= isset($satuan) ? $satuan : 'N/A' ?></dd>
