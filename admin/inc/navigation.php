...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-maroon elevation-4 sidebar-no-expand bg-gradient-purple">
        <!-- Brand Logo -->
              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=prices" class="nav-link nav-prices">
                    ...
                    <li class="nav-header">Transaksi Laboraturium</li>
                    <li class="nav-item dropdown">
                    ...
                    <li class="nav-header">Transaksi Sperma</li>
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=transactions/manage_sperma" class="nav-link nav-transactions_manage_sperm">
                        <i class="nav-icon fas fa-plus"></i>
                        <p>
                          Tambah Transaksi
                        </p>
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=transactions/index_sperma" class="nav-link nav-transactions_sperm">
                        <i class="nav-icon fas fa-folder"></i>
                        <p>
                          Daftar Transaksi
                        </p>
                    ...
                    <li class="nav-header">Laporan</li>
                      <li class="nav-item dropdown">
                        <a href="<?php echo base_url ?>admin/?page=reports/date_wise_transaction" class="nav-link nav-reports_date_wise_transaction">
                          ...
                          <p>
                            Laporan Pendapatan Lab
                          </p>
                        </a>
                      </li>
                      <li class="nav-item dropdown">
                        <a href="<?php echo base_url ?>admin/?page=reports/date_wise_payment" class="nav-link nav-reports_date_wise_payment">
                          <i class="nav-icon fas fa-circle"></i>
                          <p>
                            Laporan Pendapatan Sperm
                          </p>
                        </a>
                      </li>
                      <li class="nav-header">Diskon</li>
                      <?php if($_settings->userdata('type') == 1): ?>
                      <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=discount" class="nav-link nav-discount">
                        <i class="nav-icon fas fa-plus"></i>
                        <p>
                         Tambah Discount
                        </p>
                      ...
                      <?php endif; ?>
                      <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=discount/view_discount" class="nav-link nav-view-discount">
                        <i class="nav-icon fas fa-folder"></i>
                        <p>
                         Daftar Discount
                        </p>
